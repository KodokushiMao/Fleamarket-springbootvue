      ...
      <el-container style="height: 700px; border: 1px solid #eee">
        ...
        <el-main style="height:0;flex-grow:1;">
            ...
            @row-click="openDetails" border>
                <el-table-column prop="account" label="商家账号" width="80">
                </el-table-column>
                <el-table-column prop="oassword" label="密码" width="80">
                </el-table-column>
                ...
                <el-table-column prop="bankcard" label="银行账户" width="180" >
                </el-table-column>
                ...
                <el-table-column prop="idcard" label="身份证照片" width="200" >
                    <template slot-scope="scope">
                        <el-image style="width: 200px; height: 200px" :src="scope.row.idcard" lazy></el-image>
                    </template>
                </el-table-column>
      ...
      this.$axios.post('http://localhost:8088/getshoplevel', formData, config)
        .then(res => {
          ...
          for (var i = 0; i < res.data.length; i++) {
            this.tableData[i].licence = require('C:/Users/14505/Pictures/shop/' + this.tableData[i].licence)
            this.tableData[i].idcard = require('C:/Users/14505/Pictures/shop/' + this.tableData[i].idcard)
          }
