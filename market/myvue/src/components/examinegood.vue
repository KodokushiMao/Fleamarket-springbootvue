      ...
      <el-container style="height: 700px; border: 1px solid #eee">
        ...
        <el-main style="height:0;flex-grow:1;">
            ...
            @row-click="openDetails" border>
                <el-table-column prop="account" label="商家ID" width="80">
                </el-table-column>
                ...
                <el-table-column prop="discount" label="商品折扣" width="50">
                </el-table-column>
                <el-table-column prop="details" label="商品简介" width="120">
                </el-table-column>
                <el-table-column prop="oan" label="新旧程度" width="50">
                </el-table-column>
                <el-table-column prop="type" label="商品类别" width="50" >
                </el-table-column>
                <el-table-column prop="model" label="商品尺寸" width="100" >
                </el-table-column>
                <el-table-column prop="counteroffer" label="是否议价" width="50" >
                </el-table-column>
                <el-table-column prop="stock" label="上架数量" width="50" >
                </el-table-column>
