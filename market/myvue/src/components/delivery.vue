      ...
      <el-container style="height: 700px; border: 1px solid #eee">
        ...
        <el-main style="height:0;flex-grow:1;">
            ...
            @row-click="openDetails" border>
                <el-table-column prop="account" label="用户ID" width="80">
                </el-table-column>
                ...
                <el-table-column prop="details" label="商品简介" width="160">
                </el-table-column>
                <el-table-column prop="oan" label="新旧程度/成" width="80">
                </el-table-column>
                <el-table-column prop="type" label="商品类别" width="60" >
                </el-table-column>
                <el-table-column prop="model" label="商品尺寸" width="90" >
                </el-table-column>
                <el-table-column prop="counteroffer" label="是否议价" width="60" >
                </el-table-column>
                <el-table-column prop="num" label="商品数量" width="60" >
                </el-table-column>
...
export default {
  ...
  methods: {
      ...
      this.$axios.post('http://localhost:8088/sendgood', formData, config)
        .then(res => {
          ...
          for (let f = 0; f < this.tableData.length; f++) {
            this.tableData[f].address = '手机号:' + this.tableData[f].phone + '\xa0\xa0\xa0\xa0\xa0\xa0姓名:' + this.tableData[f].username +
    ...
    sure () { // 将商品下架
      ...
      let formData = new FormData()
      formData.append('account', this.column.account)
      formData.append('shopaccount', sessionStorage.getItem('userid'))
      formData.append('password', sessionStorage.getItem('userword'))
