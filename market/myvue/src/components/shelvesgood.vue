    ...
    shangjia (form) {
      this.$refs[form].validate((valid) => {
        if (valid) {
          ...
          formData.append('discount', this.form.zhekou)
          formData.append('details', this.form.intro)
          formData.append('oan', this.form.new)
          formData.append('type', this.form.fenlei)
          formData.append('model', this.form.size)
          formData.append('counteroffer', this.form.yijia)
          formData.append('stock', this.form.amount)
          let config = {
            headers: {
