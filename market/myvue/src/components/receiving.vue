      ...
      <el-container style="height: 700px; border: 1px solid #eee">
        ...
        <el-main style="height:0;flex-grow:1;">
            ...
            @row-click="openDetails" border>
                <el-table-column prop="shopaccount" label="商家ID" width="80">
                </el-table-column>
                ...
                <el-table-column prop="identity" label="商品状态" width="80" >
                    <template slot-scope="scope">
                        <p v-if="scope.row.identity === '4'" >待收货</p>
                    </template>
                </el-table-column>
